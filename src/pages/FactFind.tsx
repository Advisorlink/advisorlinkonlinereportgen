...
interface Dependent {
  name: string; gender: string; dob: string; age: string; annualSchoolFees: string;
}

interface EmploymentBlock {
  employmentStatus: string; hoursPerWeek: string; occupationTitle: string; industry: string;
  timeInOccupationYears: string; timeInOccupationMonths: string; timeWithEmployerYears: string;
  timeWithEmployerMonths: string; qualifications: string; ebaInPlace: string; dutiesPerformed: string;
  workAbove10m: string; workAbove10mDetails: string; officeAdminPct: string; manualFieldPct: string;
  travelPct: string; supervisionPct: string; annualLeaveDays: string; sickLeaveDays: string;
  longServiceDays: string; personalSuperContributions: string; annualIncome: string;
  annualBonus: string; annualCommissions: string; annualOvertime: string; additionalNotes: string;
}

interface SelfEmploymentBlock {
  occupationTitle: string; industry: string; qualifications: string; ebaInPlace: string;
  businessStructure: string; timeSelfEmployedYears: string; timeSelfEmployedMonths: string;
  businessOwnedPct: string; employeeCount: string; dutiesPerformed: string; workAbove10m: string;
  workAbove10mDetails: string; officeAdminPct: string; manualFieldPct: string; travelPct: string;
  supervisionPct: string; personalSuperContributions: string; annualIncome: string;
  annualDividends: string; additionalNotes: string;
}

interface AssetRow { asset: string; value: string; debt: string; owner: string; monthlyRepayments: string; }
interface ExpenseRow { expense: string; weekly: string; monthly: string; quarterly: string; annually: string; }
interface SuperFundRow { fund: string; accountNumber: string; balance: string; }
interface InsuranceRow { insurer: string; policyNumber: string; coverType: string; sumInsured: string; premiumPA: string; }
interface BeneficiaryRow { fullName: string; gender: string; relationship: string; dob: string; benefitPct: string; }

interface FactFindData {
  dateCompleted: string; client1Name: string; client2Name: string; representativeName: string;
  client1Title: string; client2Title: string; client1MiddleName: string; client2MiddleName: string;
  client1PreferredName: string; client2PreferredName: string; client1MaidenName: string; client2MaidenName: string;
  client1DOB: string; client2DOB: string; client1Gender: string; client2Gender: string;
  client1MaritalStatus: string; client2MaritalStatus: string; client1AustralianCitizen: string; client2AustralianCitizen: string;
  client1VisaDetails: string; client2VisaDetails: string; client1BankruptcyStatus: string; client2BankruptcyStatus: string;
  client1TFN: string; client2TFN: string;
  client1Mobile: string; client2Mobile: string; client1Home: string; client2Home: string;
  client1Email: string; client2Email: string;
  streetAddress: string; suburb: string; state: string; postcode: string;
  noDependents: boolean; dependents: Dependent[]; dependentsNotes: string;
  primaryEmployment1: EmploymentBlock; primaryEmployment2: EmploymentBlock;
  secondaryEmployment1: EmploymentBlock; secondaryEmployment2: EmploymentBlock;
  selfEmployment1: SelfEmploymentBlock; selfEmployment2: SelfEmploymentBlock;
  assets: AssetRow[]; expenses: ExpenseRow[];
  client1ExpenseSplitPct: string; client2ExpenseSplitPct: string; totalAnnualCoreExpenses: string;
  dependentEducationalExpenses: string[];
  client1SuperFunds: SuperFundRow[]; client2SuperFunds: SuperFundRow[];
  client1Insurance: InsuranceRow[]; client2Insurance: InsuranceRow[];
  hospitalCover: boolean; extrasCover: boolean; noneCover: boolean;
  client1HasWill: string; client2HasWill: string; client1WillLastReviewed: string; client2WillLastReviewed: string;
  client1POA: string; client2POA: string; estatePlanningNotes: string;
  client1Height: string; client2Height: string; client1Weight: string; client2Weight: string;
  client1BMI: string; client2BMI: string; client1SmokeVape: string; client2SmokeVape: string;
  client1DrinksPerWeek: string; client2DrinksPerWeek: string;
  client1RecreationalDrugs: string; client2RecreationalDrugs: string;
  client1GeneralHealth: string; client2GeneralHealth: string;
  healthConditionsNoneApply: boolean; healthConditions: Record<string, boolean>;
  healthScenariosNoneApply: boolean; healthScenarios: Record<string, boolean>;
  healthDetails: Record<string, string>;
  partBDateCompleted: string; partBAdviserName: string; initialReasonsForAdvice: string;
  objectives: { objective: string; term: string; priority: string; amountRequired: string }[];
  adviceGoalsSuper: Record<string, boolean>; adviceGoalsOutside: Record<string, boolean>;
  client1RetirementAge: string; client2RetirementAge: string;
  client1RetirementIncome: string; client2RetirementIncome: string;
  emergencyFundsNow: string; emergencyFundsRetirement: string;
  scopeOfAdvice: string; scopeLimitedAreas: Record<string, boolean>;
  scopeOther: string; scopeLimitingExplanation: string;
  investmentGoals: Record<string, string>; investmentKnowledge: Record<string, string>;
  investmentExperience: Record<string, boolean>; investmentNotes: string;
  riskAnswers: Record<string, string>;
  client1TotalPoints: string; client2TotalPoints: string;
  client1RiskProfile: string; client2RiskProfile: string;
  riskAgree: string; alteredRiskProfile: string; alteredRiskReason: string;
  insurerEmployment: Record<string, string>; primaryPhysician: Record<string, string>;
  insurerContact: Record<string, string>; insurerNotes: string;
  client1NominationType: string; client2NominationType: string;
  client1Beneficiaries: BeneficiaryRow[]; client2Beneficiaries: BeneficiaryRow[];
  beneficiaryNotes: string;
  client1FSGDate: string; client2FSGDate: string; fsgDocumentDate: string; soaFee: string;
  client1NoContact: boolean; client2NoContact: boolean;
}
...
const emptyFactFind = (): FactFindData => ({
  ...
  client1Title: "", client2Title: "", client1MiddleName: "", client2MiddleName: "",
  client1PreferredName: "", client2PreferredName: "", client1MaidenName: "", client2MaidenName: "",
  client1DOB: "", client2DOB: "", client1Gender: "", client2Gender: "",
  client1MaritalStatus: "", client2MaritalStatus: "", client1AustralianCitizen: "", client2AustralianCitizen: "",
  client1VisaDetails: "", client2VisaDetails: "", client1BankruptcyStatus: "", client2BankruptcyStatus: "",
  client1TFN: "", client2TFN: "",
  client1Mobile: "", client2Mobile: "", client1Home: "", client2Home: "",
  client1Email: "", client2Email: "",
  streetAddress: "", suburb: "", state: "", postcode: "",
  noDependents: false,
  dependents: [{ name: "", gender: "", dob: "", age: "", annualSchoolFees: "" }],
  dependentsNotes: "",
  primaryEmployment1: emptyEmployment(), primaryEmployment2: emptyEmployment(),
  secondaryEmployment1: emptyEmployment(), secondaryEmployment2: emptyEmployment(),
  selfEmployment1: emptySelfEmployment(), selfEmployment2: emptySelfEmployment(),
  assets: [...defaultAssets], expenses: [...defaultExpenses],
  client1ExpenseSplitPct: "", client2ExpenseSplitPct: "", totalAnnualCoreExpenses: "",
  ...
  client1HasWill: "", client2HasWill: "", client1WillLastReviewed: "", client2WillLastReviewed: "",
  client1POA: "", client2POA: "", estatePlanningNotes: "",
  client1Height: "", client2Height: "", client1Weight: "", client2Weight: "",
  client1BMI: "", client2BMI: "", client1SmokeVape: "", client2SmokeVape: "",
  ...
  adviceGoalsSuper: { "Insurance Inside Super": false, "Retirement Planning": false, "Super Optimisation": false },
  adviceGoalsOutside: { "Grow Wealth": false, "Manage Cash Flow and Debt": false, "Plan for Major Life Events": false, "Plan for Retirement and Aged Care": false, "Other": false },
  ...
  scopeOfAdvice: "",
  scopeLimitedAreas: { "Aged Care Planning": false, "Budgeting and Cash Flow": false, "Debt Management": false, "Estate Planning": false, "Investment Advice": false, "Personal Insurance": false, "Retirement Planning": false, "Superannuation": false },
  scopeOther: "", scopeLimitingExplanation: "",
  investmentGoals: {}, investmentKnowledge: {},
  investmentExperience: { "Derivatives": false, "Exchange-Traded Funds (ETFs)": false, "Managed Funds": false, "Property": false, "Shares": false, "Term Deposits": false },
  investmentNotes: "",
  riskAnswers: {},
...
export default function FactFind() {
  ...
  const exportPDF = async () => {
    ...
    try {
      ...
      const dualRow = (label: string, v1: string, v2: string, bg = false) => {
        checkSpace(8);
        if (bg) { pdf.setFillColor(lightGray[0], lightGray[1], lightGray[2]); pdf.rect(margin, y - 1, contentW, 7, "F"); }
        pdf.setFontSize(8); pdf.setFont("helvetica", "normal");
        pdf.setTextColor(100, 100, 100); pdf.text(label, margin + 2, y + 4);
        pdf.setTextColor(darkText[0], darkText[1], darkText[2]);
      ...
      try {
        ...
        if (ctx) { ctx.drawImage(logoImg, 0, 0, 400, 100); }
      ...
      pdf.text("(07) 5241 1244", W - margin, 32, { align: "right" });
      ...
      pdf.setFontSize(9); pdf.setFont("helvetica", "normal");
      pdf.setTextColor(cyan[0], cyan[1], cyan[2]);
      pdf.text("Date Completed", margin + 8, 182);
      pdf.text("Client 1 Name", margin + 8, 194);
      pdf.text("Client 2 Name", margin + 8, 206);
      pdf.setTextColor(white[0], white[1], white[2]);
      pdf.text(data.dateCompleted, margin + 55, 182);
      ...
      pdf.text(noticeLines, margin + 5, 240);

      // ── PERSONAL DETAILS ──
      addPage();
      sectionHeader("Personal Details");
      pdf.setFontSize(8); pdf.setFont("helvetica", "bold");
      pdf.text("", margin + 2, y + 4); pdf.text("Client 1", margin + 65, y + 4); pdf.text("Client 2", margin + 125, y + 4);
      y += 7; pdf.setFont("helvetica", "normal");

      const personalFields = [
        ["Title", data.client1Title, data.client2Title], ["Client name", data.client1Name, data.client2Name],
        ["Middle name", data.client1MiddleName, data.client2MiddleName], ["Preferred name", data.client1PreferredName, data.client2PreferredName],
        ["Maiden name", data.client1MaidenName, data.client2MaidenName], ["Date of Birth", data.client1DOB, data.client2DOB],
        ["Gender", data.client1Gender, data.client2Gender], ["Marital status", data.client1MaritalStatus, data.client2MaritalStatus],
        ["Australian citizen", data.client1AustralianCitizen, data.client2AustralianCitizen], ["Visa details", data.client1VisaDetails, data.client2VisaDetails],
        ["Bankruptcy status", data.client1BankruptcyStatus, data.client2BankruptcyStatus], ["Tax file number", data.client1TFN, data.client2TFN],
      ];
      personalFields.forEach(([l, v1, v2], i) => dualRow(l, v1, v2, i % 2 === 0));

      y += 4; sectionHeader("Contact Details");
      pdf.setFont("helvetica", "bold"); pdf.setFontSize(8);
      pdf.text("", margin + 2, y + 4); pdf.text("Client 1", margin + 65, y + 4); pdf.text("Client 2", margin + 125, y + 4);
      y += 7; pdf.setFont("helvetica", "normal");
      [["Mobile", data.client1Mobile, data.client2Mobile], ["Home", data.client1Home, data.client2Home], ["Email", data.client1Email, data.client2Email]]
        .forEach(([l, v1, v2], i) => dualRow(l, v1, v2, i % 2 === 0));
      ...
      y += 4; sectionHeader("Dependents");
      if (data.noDependents) { singleRow("", "No dependents"); }
      else { data.dependents.forEach((d, i) => { if (d.name) dualRow(`Dependent ${i + 1}`, `${d.name} (${d.gender})`, `DOB: ${d.dob} | Fees: ${d.annualSchoolFees}`, i % 2 === 0); }); }

      // Employment
      const printEmployment = (title: string, e: EmploymentBlock) => {
        addPage(); sectionHeader(title);
        pdf.setFont("helvetica", "bold"); pdf.setFontSize(8); pdf.text("", margin + 2, y + 4); pdf.text("Client 1", margin + 65, y + 4); y += 7; pdf.setFont("helvetica", "normal");
        const fields = [["Employment status", e.employmentStatus], ["Hours worked per week", e.hoursPerWeek], ["Occupation/Title", e.occupationTitle], ["Industry", e.industry],
          ["Time in occupation", `${e.timeInOccupationYears}y ${e.timeInOccupationMonths}m`], ["Time with employer", `${e.timeWithEmployerYears}y ${e.timeWithEmployerMonths}m`],
          ["Qualifications", e.qualifications], ["EBA in place", e.ebaInPlace], ["Duties performed", e.dutiesPerformed], ["Work above 10m/underground", e.workAbove10m],
          ["Office/Admin %", e.officeAdminPct], ["Manual/Field %", e.manualFieldPct], ["Travel %", e.travelPct], ["Supervision %", e.supervisionPct],
          ["Annual leave days", e.annualLeaveDays], ["Sick leave days", e.sickLeaveDays], ["Long service leave days", e.longServiceDays],
          ["Personal super contributions", e.personalSuperContributions], ["Annual income", e.annualIncome], ["Annual bonus", e.annualBonus],
          ["Annual commissions", e.annualCommissions], ["Annual overtime", e.annualOvertime]];
      ...
      const printSelf = (title: string, s: SelfEmploymentBlock) => {
        addPage(); sectionHeader(title);
        const fields = [["Occupation/Title", s.occupationTitle], ["Industry", s.industry], ["Qualifications", s.qualifications],
          ["Business structure", s.businessStructure], ["Time self-employed", `${s.timeSelfEmployedYears}y ${s.timeSelfEmployedMonths}m`],
          ["% business owned", s.businessOwnedPct], ["Number of employees", s.employeeCount], ["Duties performed", s.dutiesPerformed],
          ["Work above 10m", s.workAbove10m], ["Office/Admin %", s.officeAdminPct], ["Manual/Field %", s.manualFieldPct],
      ...
      pdf.setFontSize(8); pdf.setFont("helvetica", "bold");
      pdf.text("Asset", margin + 2, y + 4); pdf.text("Value", margin + 55, y + 4); pdf.text("Debt", margin + 80, y + 4); pdf.text("Owner", margin + 105, y + 4); pdf.text("Monthly Repay.", margin + 140, y + 4);
      y += 7; pdf.setFont("helvetica", "normal");
      data.assets.forEach((a, i) => {
        checkSpace(8);
        if (i % 2 === 0) { pdf.setFillColor(lightGray[0], lightGray[1], lightGray[2]); pdf.rect(margin, y - 1, contentW, 7, "F"); }
        pdf.setFontSize(7); pdf.text(a.asset, margin + 2, y + 4); pdf.text(a.value, margin + 55, y + 4); pdf.text(a.debt, margin + 80, y + 4); pdf.text(a.owner, margin + 105, y + 4); pdf.text(a.monthlyRepayments, margin + 140, y + 4);
        y += 7;
      });

      y += 4; sectionHeader("Living Expenses");
      pdf.setFontSize(8); pdf.setFont("helvetica", "bold");
      pdf.text("Expense", margin + 2, y + 4); pdf.text("Weekly", margin + 65, y + 4); pdf.text("Monthly", margin + 90, y + 4); pdf.text("Quarterly", margin + 115, y + 4); pdf.text("Annually", margin + 145, y + 4);
      y += 7; pdf.setFont("helvetica", "normal");
      data.expenses.forEach((e, i) => {
        checkSpace(8);
        if (i % 2 === 0) { pdf.setFillColor(lightGray[0], lightGray[1], lightGray[2]); pdf.rect(margin, y - 1, contentW, 7, "F"); }
        pdf.setFontSize(7); pdf.text(e.expense, margin + 2, y + 4); pdf.text(e.weekly, margin + 65, y + 4); pdf.text(e.monthly, margin + 90, y + 4); pdf.text(e.quarterly, margin + 115, y + 4); pdf.text(e.annually, margin + 145, y + 4);
        y += 7;
      });
      ...
      // Health
      addPage(); sectionHeader("Health Details & Medical History");
      ...
      y = 60; pdf.setTextColor(darkText[0], darkText[1], darkText[2]);
      ...
      y += 4; sectionHeader("Objectives");
      data.objectives.forEach((o, i) => { if (o.objective) singleRow(`Objective ${i + 1}`, `${o.objective} | Term: ${o.term} | Priority: ${o.priority} | $${o.amountRequired}`, i % 2 === 0); });

      y += 4; sectionHeader("Advice Goals");
      Object.entries(data.adviceGoalsSuper).forEach(([k, v]) => { if (v) singleRow("Super: " + k, "✓"); });
      Object.entries(data.adviceGoalsOutside).forEach(([k, v]) => { if (v) singleRow("Outside Super: " + k, "✓"); });
      ...
      addPage(); sectionHeader("Risk Profile Results");
        ...
        <div className="max-w-3xl mx-auto p-6 space-y-6">
          ...
          <div className="grid gap-3">
            {filteredReports.map(r => (
              <button key={r.id} onClick={() => selectClient(r)} className="flex items-center gap-4 p-4 rounded-xl border border-border bg-card hover:bg-accent/50 transition-colors text-left w-full">
                ...
                <div className="flex-1 min-w-0"><p className="font-semibold truncate">{r.client_name}</p><p className="text-xs text-muted-foreground">{new Date(r.created_at).toLocaleDateString()}</p></div>
                <ArrowLeft className="w-4 h-4 text-muted-foreground rotate-180" />
              </button>
            ))}
            {filteredReports.length === 0 && (<p className="text-center text-muted-foreground py-8">No clients found. Generate a report first to populate the client list.</p>)}
          </div>
        </div>
      </CRMLayout>
    );
  ...
  /* ─── Employment renderer ─── */
  const renderEmploymentFields = (emp: EmploymentBlock, empKey: string, clientNum: 1 | 2) => {
    const updateEmp = (field: keyof EmploymentBlock, value: string) => {
      updateData({ [empKey]: { ...emp, [field]: value } } as any);
    };
    return (
      <div className="space-y-3 p-4 rounded-lg border">
        <h4 className="font-semibold text-sm">Client {clientNum}</h4>
        <Field label="Employment status" value={emp.employmentStatus} onChange={v => updateEmp("employmentStatus", v)} />
        <Field label="Hours worked per week" value={emp.hoursPerWeek} onChange={v => updateEmp("hoursPerWeek", v)} />
        <Field label="Occupation/Title" value={emp.occupationTitle} onChange={v => updateEmp("occupationTitle", v)} />
        <Field label="Industry" value={emp.industry} onChange={v => updateEmp("industry", v)} />
        <div className="grid grid-cols-2 gap-2">
          <Field label="Time in occupation (Years)" value={emp.timeInOccupationYears} onChange={v => updateEmp("timeInOccupationYears", v)} />
          <Field label="Months" value={emp.timeInOccupationMonths} onChange={v => updateEmp("timeInOccupationMonths", v)} />
        </div>
        <div className="grid grid-cols-2 gap-2">
          <Field label="Time with employer (Years)" value={emp.timeWithEmployerYears} onChange={v => updateEmp("timeWithEmployerYears", v)} />
          <Field label="Months" value={emp.timeWithEmployerMonths} onChange={v => updateEmp("timeWithEmployerMonths", v)} />
        </div>
        <Field label="Relevant qualifications" value={emp.qualifications} onChange={v => updateEmp("qualifications", v)} />
        <Field label="Are any EBA's in place?" value={emp.ebaInPlace} onChange={v => updateEmp("ebaInPlace", v)} />
        <div><Label className="text-xs text-muted-foreground">Duties performed (day-to-day)</Label><Textarea value={emp.dutiesPerformed} onChange={e => updateEmp("dutiesPerformed", e.target.value)} className="text-sm" rows={2} /></div>
        <Field label="Do you work above 10m or underground?" value={emp.workAbove10m} onChange={v => updateEmp("workAbove10m", v)} />
        {emp.workAbove10m?.toLowerCase().includes("yes") && <Field label="Details" value={emp.workAbove10mDetails} onChange={v => updateEmp("workAbove10mDetails", v)} />}
        <h5 className="font-semibold text-xs mt-2">Working Conditions (%)</h5>
        <div className="grid grid-cols-2 gap-2">
          <Field label="Office / Admin %" value={emp.officeAdminPct} onChange={v => updateEmp("officeAdminPct", v)} />
          <Field label="Manual / Field work %" value={emp.manualFieldPct} onChange={v => updateEmp("manualFieldPct", v)} />
          <Field label="Travel %" value={emp.travelPct} onChange={v => updateEmp("travelPct", v)} />
          <Field label="Supervision %" value={emp.supervisionPct} onChange={v => updateEmp("supervisionPct", v)} />
        </div>
        <h5 className="font-semibold text-xs mt-2">Leave Information</h5>
        <div className="grid grid-cols-3 gap-2">
          <Field label="Annual leave days" value={emp.annualLeaveDays} onChange={v => updateEmp("annualLeaveDays", v)} />
          <Field label="Sick leave days" value={emp.sickLeaveDays} onChange={v => updateEmp("sickLeaveDays", v)} />
          <Field label="Long service leave" value={emp.longServiceDays} onChange={v => updateEmp("longServiceDays", v)} />
        </div>
        <h5 className="font-semibold text-xs mt-2">Income Details</h5>
        <Field label="Personal super contributions?" value={emp.personalSuperContributions} onChange={v => updateEmp("personalSuperContributions", v)} />
        <div className="grid grid-cols-2 gap-2">
          <Field label="Annual income" value={emp.annualIncome} onChange={v => updateEmp("annualIncome", v)} />
          <Field label="Annual bonus" value={emp.annualBonus} onChange={v => updateEmp("annualBonus", v)} />
          <Field label="Annual commissions" value={emp.annualCommissions} onChange={v => updateEmp("annualCommissions", v)} />
          <Field label="Annual overtime" value={emp.annualOvertime} onChange={v => updateEmp("annualOvertime", v)} />
        </div>
        <div><Label className="text-xs text-muted-foreground">Additional notes</Label><Textarea value={emp.additionalNotes} onChange={e => updateEmp("additionalNotes", e.target.value)} className="text-sm" rows={2} /></div>
      </div>
    );
  };

  /* ─── Self-employment renderer ─── */
  const renderSelfEmployment = (se: SelfEmploymentBlock, seKey: string, clientNum: 1 | 2) => {
    const updateSE = (field: keyof SelfEmploymentBlock, value: string) => {
      updateData({ [seKey]: { ...se, [field]: value } } as any);
    };
    return (
      <div className="space-y-3 p-4 rounded-lg border">
        <h4 className="font-semibold text-sm">Client {clientNum}</h4>
        ...
        <Field label="Number of employees" value={se.employeeCount} onChange={v => updateSE("employeeCount", v)} />
        <div><Label className="text-xs text-muted-foreground">Duties performed</Label><Textarea value={se.dutiesPerformed} onChange={e => updateSE("dutiesPerformed", e.target.value)} className="text-sm" rows={2} /></div>
        <Field label="Work above 10m or underground?" value={se.workAbove10m} onChange={v => updateSE("workAbove10m", v)} />
        {se.workAbove10m?.toLowerCase().includes("yes") && <Field label="Details" value={se.workAbove10mDetails} onChange={v => updateSE("workAbove10mDetails", v)} />}
        <div className="grid grid-cols-2 gap-2">
          <Field label="Office / Admin %" value={se.officeAdminPct} onChange={v => updateSE("officeAdminPct", v)} />
          <Field label="Manual / Field work %" value={se.manualFieldPct} onChange={v => updateSE("manualFieldPct", v)} />
        ...
        <div><Label className="text-xs text-muted-foreground">Additional notes</Label><Textarea value={se.additionalNotes} onChange={e => updateSE("additionalNotes", e.target.value)} className="text-sm" rows={2} /></div>
      </div>
    );
  };
  ...
  const allActiveHealth = [...activeConditions, ...activeScenarios];

  /* ─── Insurer fields ─── */
  const empFields = ["daysWorkedPerWeek", "weeksWorkedPerYear", "employerName", "employerStreet", "employerSuburb", "employerState", "employerPostcode", "expectEarnAsMuch", "plansToChangeOccupation"];
  const empLabels = ["Days worked per week", "Weeks worked per year", "Employer name", "Street address", "Suburb", "State", "Postcode", "Expect to earn as much this year?", "Plans to change occupation or hours?"];
  const physFields = ["physicianName", "practiceName", "practicePhone", "practiceStreet", "practiceSuburb", "practiceState", "practicePostcode"];
  const physLabels = ["Physician name", "Practice name", "Practice phone number", "Street address", "Suburb", "State", "Postcode"];
  ...
  return (
    <CRMLayout>
      <div className="h-full overflow-y-auto">
        ...
        {/* All sections as one continuous form */}
        <div className="max-w-3xl mx-auto p-6 space-y-2">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-lg bg-muted/50 text-xs text-muted-foreground">
              ...
              <p>The factual information provided in this section is collected prior to any advice discussion and is reviewed by a licensed financial adviser before any advice is provided. This information alone does not constitute personal financial advice.</p>
            </div>
          </div>
          ...
          {/* Dependents */}
          <SectionDivider title="Dependents" />
          <div className="space-y-4">
            <div className="flex items-center gap-2"><Checkbox checked={data.noDependents} onCheckedChange={v => updateData({ noDependents: !!v })} /><Label className="text-sm">No dependents</Label></div>
            {!data.noDependents && (
              <>
                <div className="grid grid-cols-5 gap-2 text-xs font-semibold text-muted-foreground"><span>Name</span><span>Gender</span><span>Date of Birth</span><span>Age</span><span>Annual School Fees</span></div>
                ...
                <Button variant="outline" size="sm" onClick={() => updateData({ dependents: [...data.dependents, { name: "", gender: "", dob: "", age: "", annualSchoolFees: "" }] })}>+ Add Dependent</Button>
              </>
            )}
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-5 gap-2 text-xs font-semibold text-muted-foreground"><span>Asset</span><span>Value</span><span>Debt</span><span>Owner</span><span>Monthly Repay.</span></div>
            {data.assets.map((a, i) => (
              <div key={i} className="grid grid-cols-5 gap-2">
            ...
            <Button variant="outline" size="sm" onClick={() => updateData({ assets: [...data.assets, { asset: "", value: "", debt: "", owner: "", monthlyRepayments: "" }] })}>+ Add Asset Row</Button>
          </div>

          {/* Living Expenses */}
          <SectionDivider title="Living Expenses" />
          <div className="space-y-4">
            <div className="grid grid-cols-5 gap-2 text-xs font-semibold text-muted-foreground"><span>Expense</span><span>Weekly</span><span>Monthly</span><span>Quarterly</span><span>Annually</span></div>
          ...
          {/* Estate Planning */}
          <SectionDivider title="Estate Planning" />
          <div className="space-y-4">
            ...
            <div><Label className="text-xs text-muted-foreground">Additional notes</Label><Textarea value={data.estatePlanningNotes} onChange={e => updateData({ estatePlanningNotes: e.target.value })} className="text-sm" rows={3} /></div>
          </div>

          {/* Health Details */}
          <SectionDivider title="Health Details & Medical History" />
          <div className="space-y-4">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              {empFields.map((f, i) => (
                <DualField key={f} label={empLabels[i]}
                  v1={data.insurerEmployment[`c1_${f}`] || ""} v2={data.insurerEmployment[`c2_${f}`] || ""}
            ...
            <div className="space-y-3 pt-4 border-t">
              ...
              {physFields.map((f, i) => (
                <DualField key={f} label={physLabels[i]}
                  v1={data.primaryPhysician[`c1_${f}`] || ""} v2={data.primaryPhysician[`c2_${f}`] || ""}
            ...
            <div className="space-y-3 pt-4 border-t">
              ...
              {contactFields.map((f, i) => (
                <DualField key={f} label={contactLabels[i]}
                  v1={data.insurerContact[`c1_${f}`] || ""} v2={data.insurerContact[`c2_${f}`] || ""}
            ...
            <div><Label className="text-xs text-muted-foreground">Additional notes</Label><Textarea value={data.insurerNotes} onChange={e => updateData({ insurerNotes: e.target.value })} className="text-sm" rows={3} /></div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-lg bg-muted/50 text-xs text-muted-foreground space-y-3">
              ...
              <p>I declare that the information provided in this fact find is complete and accurate to the best of my knowledge.</p>
              ...
              <p>I agree to the collection and retention of my Tax File Number (TFN).</p>
            </div>
            <div className="space-y-2">
