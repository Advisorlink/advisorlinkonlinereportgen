  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#f0f4f9] to-[#e8eff8] flex items-center justify-center">
        <div className="animate-pulse text-[#29B6F6] text-lg">Loading...</div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#f0f4f9] to-[#e8eff8] flex items-center justify-center p-4">
        <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full p-10 text-center">
          <div className="w-20 h-20 bg-[#29B6F6]/10 rounded-full flex items-center justify-center mx-auto mb-6">
            <CheckCircle className="w-10 h-10 text-[#29B6F6]" />
          </div>
          ...
          <p className="text-[#444455] text-lg leading-relaxed mb-3">
            ...
            <strong className="text-[#29B6F6]">24-48 hours</strong> to get
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          {[
            ...
            >
              <div className="w-10 h-10 bg-[#29B6F6]/10 rounded-lg flex items-center justify-center mx-auto mb-3">
          ...
          <div className="p-6 md:p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FieldGroup icon={User} label="Full Name">
                  <Input
                    ...
                    className="border-[#e0e0e8] focus:border-[#29B6F6] focus:ring-[#29B6F6]/20"
                  />
                </FieldGroup>
                ...
                <FieldGroup icon={DollarSign} label="Approximate Super Balance">
                  <div className="relative">
                    <select
                      ...
                      className="w-full h-10 rounded-md border border-[#e0e0e8] bg-white px-3 py-2 text-sm focus:border-[#29B6F6] focus:ring-2 focus:ring-[#29B6F6]/20 focus:outline-none appearance-none pr-10"
                    >
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`flex-1 py-3 rounded-xl border-2 text-sm font-semibold transition-all duration-200 ${
                        hadReview === opt.value
                          ? "border-[#29B6F6] bg-[#29B6F6]/5 text-[#29B6F6]"
                          : "border-[#e0e0e8] text-[#7a7a8e] hover:border-[#29B6F6]/40"
                      }`}
                    >
                      {opt.label}
                    </button>
            ...
            <div className="mt-8 flex flex-col items-center gap-3">
              <Button
                ...
                disabled={submitting}
                className="bg-[#29B6F6] hover:bg-[#1E88E5] text-white px-12 py-6 text-lg rounded-xl shadow-lg shadow-[#29B6F6]/25 transition-all duration-200 hover:shadow-xl hover:shadow-[#29B6F6]/30 w-full md:w-auto"
              >
