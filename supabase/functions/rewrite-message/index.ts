...
- The ONLY exception to Australian spelling is the brand name: always write "Advisor Link Online" (never "Adviser Link Online").
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    out = out.replace(/\bAdviser Link Online\b/gi, "Advisor Link Online");
